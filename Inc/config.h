...
// Limitation settings
#define I_MOT_MAX       15              // prev(15) [A] Maximum single motor current limit
#define I_DC_MAX        17              // prev(17) [A] Maximum stage2 DC Link current limit for Commutation and Sinusoidal types (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A)
#define N_MOT_MAX       300            // prev(350) [rpm] Maximum motor speed limit
...
#define DEFAULT_SPEED_COEFFICIENT   16384  //prev(16384) Default for SPEED_COEFFICIENT 1.0f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14
