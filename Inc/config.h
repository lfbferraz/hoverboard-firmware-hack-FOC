...
// Limitation settings
#define I_MOT_MAX       10              // prev(15) [A] Maximum single motor current limit
#define I_DC_MAX        12              // prev(17) [A] Maximum stage2 DC Link current limit for Commutation and Sinusoidal types (This is the final current protection. Above this value, current chopping is applied. To avoid this make sure that I_DC_MAX = I_MOT_MAX + 2A)
#define N_MOT_MAX       100            // prev(300) [rpm] Maximum motor speed limit
...
// #define STANDSTILL_HOLD_ENABLE          // [-] Flag to hold the position when standtill is reached. Only available and makes sense for VOLTAGE or TORQUE mode.
 ...
 #define ELECTRIC_BRAKE_THRES  100       // (0, 500) Threshold below at which the electric brake starts engaging.
...
#define DEFAULT_RATE                480   //prev(480) 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767)
#define DEFAULT_FILTER              6553  //prev(6553) Default for FILTER 0.1f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0].
#define DEFAULT_SPEED_COEFFICIENT   10384  //prev(16384) Default for SPEED_COEFFICIENT 1.0f [-] higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14
