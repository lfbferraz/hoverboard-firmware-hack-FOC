...
#define DEFAULT_RATE                96   //prev(480) 30.0f [-] lower value == slower rate [0, 32767] = [0.0, 2047.9375]. Do NOT make rate negative (>32767)
#define DEFAULT_FILTER              1310  //prev(6553) Default for FILTER 0.1f [-] lower value == softer filter [0, 65535] = [0.0 - 1.0].
