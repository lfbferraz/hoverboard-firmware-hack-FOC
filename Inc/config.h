...
*/
  ...
  #define FILTER                  20000    // 0.1f [-] fixdt(0,16,16) lower value == softer filter [0, 65535] = [0.0 - 1.0].
  #define SPEED_COEFFICIENT       20000   // 1.0f [-] fixdt(1,16,14) higher value == stronger. [0, 65535] = [-2.0 - 2.0]. In this case 16384 = 1.0 * 2^14
...
// ############################ VARIANT_HOVERCAR SETTINGS ############################
  ...
  #define MULTI_MODE_DRIVE                  // This option enables the selection of 3 driving modes at start-up using combinations of Brake and Throttle pedals (see below)
      ...
      #define MULTI_MODE_M1_N_MOT_MAX   60
      ...
      #define MULTI_MODE_M2_N_MOT_MAX   140
      ...
      #define MULTI_MODE_M3_N_MOT_MAX   200
  #endif
